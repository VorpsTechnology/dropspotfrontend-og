        ...
        <h5 style={heading}>Women ‘s Clothing / Tops & Sets / {post.name}  </h5> 
          <div className="row m-0">
            ...
            <div className="col-lg-4 left-side-product-box pb-3">
              ...
              <img src={preview ?"http://localhost:5000/images/"+ preview:""} style={{marginTop:"20px"}}/>
              <span className="sub-img">
              <img src={post.image2?"http://localhost:5000/images/"+ post.image1:""} style={{width:"3rem",height:"3rem"}}  onClick={()=>{
                setPreview(post.image1)
              }}/>
                <img src={post.image2?"http://localhost:5000/images/"+post.image2:""} style={{width:"3rem",height:"3rem"}}  onClick={()=>{
                setPreview(post.image2)
              }}/>
                <img src={post.image3?"http://localhost:5000/images/"+post.image3:"" } style={{width:"3rem",height:"3rem"}}  onClick={()=>{
